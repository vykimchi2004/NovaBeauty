...
public interface OrderRepository extends JpaRepository<Order, String> {
    ...
    @Query(
            "SELECT COUNT(o) FROM Order o WHERE o.orderDateTime BETWEEN :start AND :end AND o.status = 'CANCELLED'")
    ...
    @Query(
            "SELECT COUNT(o) FROM Order o WHERE o.orderDateTime BETWEEN :start AND :end AND o.status = 'REFUNDED'")
